...
public class HolidayTookController {
    ...
    public ResponseEntity<List<HolidayTookResponse>> getHolidayTook(@PathVariable("user_id") UserId userId) {
    ...
    public ResponseEntity<Void> deleteHolidayTook(@PathVariable("user_id") UserId userId, @PathVariable("event_id") String eventId) {
